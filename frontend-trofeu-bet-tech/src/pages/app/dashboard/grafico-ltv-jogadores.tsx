...
import { GraficoLtvBody } from "@/api/charts/dashboard/grafico-ltv-jogadores";
    ...
    <Card className="rounded-xl">
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          ...
          <CardDescription>
            Temos <span className="text-xl">{totalPlayers} Jogadores</span> entre {date_init} e {date_finish}
          </CardDescription>
        </div>
